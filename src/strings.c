...
const u8 gText_DexHoennTitle[] = _("Oniria Dex");
...
const u8 gText_DexHoennDescription[] = _("Oniria region's Pokédex");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Oniria region.");
...
const u8 gText_DexHoenn[] = _("Oniria");
