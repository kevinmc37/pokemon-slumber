...
#define STATUS_FIELD_SHADOW_TERRAIN     0x1000

#define STATUS_TERRAIN_ANY              (STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_SHADOW_TERRAIN)
...
#define MOVE_EFFECT_RECOIL_MAX_HP       0x46
#define MOVE_EFFECT_RECOIL_CURRENT_HP   0x47
